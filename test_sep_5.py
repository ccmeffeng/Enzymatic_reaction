...
rxns = open('fullset_2.txt', 'r').readlines()
random.shuffle(rxns)
...
np.save('test_set_4.npy', test_set)
np.save('test_set_label_4.npy', test_set_label)
np.save('training_set_4.npy', training_set)
np.save('training_set_label_4.npy', training_set_label)
np.save('validation_set_4.npy', validation_set)
np.save('validation_set_label_4.npy', validation_set_label)
