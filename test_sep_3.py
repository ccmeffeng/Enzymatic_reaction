...
for line in rxns:
    ...
    for j in range(150):
        if j < len(lst):
            ...
            lst.append(0.0)
    lst2 = [lst[i : i + 3] for i in range(0, 150, 3)]
    data.append(lst2)
...
np.save('test_set_2.npy', test_set)
np.save('test_set_label_2.npy', test_set_label)
np.save('training_set_2.npy', training_set)
np.save('training_set_label_2.npy', training_set_label)
np.save('validation_set_2.npy', validation_set)
np.save('validation_set_label_2.npy', validation_set_label)
